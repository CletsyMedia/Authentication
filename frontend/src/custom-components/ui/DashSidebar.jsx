...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        className={`fixed h-screen sm-max:fixed sm-max:top-0 sm-max:bottom-0 sm-max:h-full bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100 shadow-md flex flex-col transition-all duration-300 ease-in-out z-40 ${
          isOpen 
