...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        className={`fixed bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100 min-h-screen shadow-md flex flex-col transition-all duration-300 ease-in-out z-50 ${
          isOpen 
